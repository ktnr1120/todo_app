...
export const getTasks = async (params = {}) => {
  ...
  try {
    const response = await client.get(API_BASE_URL, { params });
...
export const getTaskById = async (id) => {
  try {
    const response = await client.get(`${API_BASE_URL}/${id}`);
    return response.data;
  } catch (error) {
...
export const createTask = async (taskData) => {
  ...
  try {
    const response = await client.post(API_BASE_URL, taskData);
...
export const updateTask = async (id, taskData) => {
  try {
    const response = await client.put(`${API_BASE_URL}/${id}`, taskData);
    return response.data;
  } catch (error) {
...
export const deleteTask = async (id) => {
  try {
    const response = await client.delete(`${API_BASE_URL}/${id}`);
    return response.data;
  } catch (error) {
